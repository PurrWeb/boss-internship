...
describe ImportStaffMemberFromCSV do
  ...
  let(:user_1_row) do
    ["Lover", "Greg", "Bar Staff", "19/03/2014", "JM034753D", "Male", "01/09/1992",  "The Blue Chapliaincy",  "Yellow Street", "Liverpool", "", "Merseyside", "UK", "L8 7EG", "Pay Rate 1"]
  end
  let(:user_2_row) do
    ["Sam", "Reed", "Manager", "20/10/2014", "JM033743D", "Female", "20/09/1992",  "30 John Road", "Southlands", "Liverpool", "", "Merseyside", "UK", "L8 7EG", "Pay Rate 1"]
  end
