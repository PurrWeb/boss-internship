  ...
  def to_s
    CSV.generate do |csv|
      ...
      staff_members.each do |staff_member|
        ...
        raise "Attempt to export incomplete finance report for staff member #{staff_member.id}" unless FinanceReportCompletionStatus.new(finance_report: report).status_text === FinanceReport::REPORT_STATUS_DONE_STATUS
