        ...
        return (
            <div className="row staff-list-item rota-staff-list-item">
                <div className="small-12  large-3 columns">
                    <img src={staff.avatar_url} className="boss3-avatar boss3-avatar_type_big" />
                </div>
                <div className="columns large-9">
                    ...
                    <div className="row">
                        ...
                        <div className="large-shrink small-12 column">
                            ...
                            <StaffMemberHolidaysLink className="boss3-button boss3-button_type_small boss3-button_role_edit" staffMemberServerId={staff.serverId} >
                                Edit
