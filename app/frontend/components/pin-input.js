...
class NumPadButton extends React.Component {
    render(){
        return <div
                className="boss3-modal-window__numpad-button"
...
class NumPad extends React.Component {
    render(){
        return <div className="boss3-modal-window__numpad">
            <div className="boss3-modal-window__numpad-row">
            ...
            <div className="boss3-modal-window__numpad-row">
                <div className="boss3-modal-window__numpad-button">&nbsp;</div>
...
export default class PinInput extends React.Component {
    ...
    render(){
        return <div className="boss3-modal-window__controls-block" >
                <input
                    className="boss3-input boss3-input_big boss3-input_role_in-modal-window boss3-input_role_pin boss3-modal-window_adjust_input-pin"
                    type="password"
