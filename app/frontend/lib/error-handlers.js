                ...
                <div class="boss-page-main__content">
                    <div class="boss-page-main__inner">
                        <div class="boss-error">
                            ...
                            <p class="boss-error__text">There was an error in the code on this page. If the problem persists please let an admin know what happened so that they can relay this to the technical team.</p>
