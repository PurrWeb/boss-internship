...
export const isWrongFileExtension = 'It should be a proper file extension!';
export const fileSizeIsTooBig = 'File Size is Too Big!';
export const formatInvalid = 'Format Invalid';
