...
export const undoAcceptedAccessoryRequestRequest = ({venueId, accessoryId, requestId}) => {
  return http().post(`/api/v1/accessory-requests/${requestId}/undo-accepted`, {
      venueId,
      accessoryId,
  });
}

export const undoRejectedAccessoryRequestRequest = ({venueId, accessoryId, requestId}) => {
  return http().post(`/api/v1/accessory-requests/${requestId}/undo-rejected`, {
      venueId,
      accessoryId,
  });
}
