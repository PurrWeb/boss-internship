...
export default class NoteForm extends React.Component {
  ...
  handleSubmit() {
    ...
    this.props.addNote(this.props.selectedMaintenanceTask, this.state.noteValue).then((argument) => {
  ...
  render() {
    return (
      <Form model="maintenanceTaskNote" className="boss-form" onSubmit={ this.handleSubmit.bind(this) }>
