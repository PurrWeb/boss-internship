...
import { PAYROLL_REPORT_SHOW_ALL_FILTER_TYPE, FILTER_TITLES, FILTER_TABS } from '../constants';
...
class PayrollReportsFilter extends Component {
  ...
  getActiveTabFromQueryString = () => {
    const activeTab = queryString.parse(window.location.search).tab || PAYROLL_REPORT_SHOW_ALL_FILTER_TYPE;
