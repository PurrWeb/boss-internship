...
function SportsTaskForm({ initialValues, message, handleSubmit, submitting, submission, venueOptions, setMessageState, setTitleState, actionValue }) {
...
SportsTaskForm = reduxForm({
  form: 'sports-task-form',
})(SportsTaskForm);

const selector = formValueSelector('sports-task-form');
