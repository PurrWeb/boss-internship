class CompositeRotaForecast
  ...
  def initialize(forecasted_take_cents:, total_cents:, overhead_total_cents:, staff_total_cents:, pr_total_cents:, kitchen_total_cents:, security_total_cents:)
  ...
  attr_reader :forecasted_take_cents
