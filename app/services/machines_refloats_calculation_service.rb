class MachinesRefloatsCalculationService
  ...
  def call
    ...
    calculated_float_topup_cents = cash_out_x_10p_diff_cents - (refill_x_10p_diff_cents - last_float_topup_cents) + last_untoppedup_float_cents
    calculated_money_banked_cents = cash_in_x_10p_diff_cents - (refill_x_10p_diff_cents - last_float_topup_cents) + last_unbanked_cents

    return {
      calculated_float_topup_cents: calculated_float_topup_cents,
      calculated_money_banked_cents: calculated_money_banked_cents
    }
  end
end
